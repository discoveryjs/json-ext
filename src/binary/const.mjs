...
export const ARRAY_ENCODING_VLQ_4BIT_INDEX = 4;
export const ARRAY_ENCODING_INT_VLQ_4BIT_INDEX = 5;
export const ARRAY_ENCODING_BIT_PACKING = 6;
export const ARRAY_ENCODING_INT_BIT_PACKING = 7;
export const ARRAY_ENCODING_PROGRESSION = 8;

export const ARRAY_LOWERING_NONE = 0;
